...
class BLanding extends StatefulWidget {
  @override
  State<BLanding> createState() => _BLandingState();
}

class _BLandingState extends State<BLanding> {
  Future<void> _launchInBrowserE(String url) async {
      ...
      WidgetsBinding.instance?.addPostFrameCallback((_) async {
        await showDialog<String>(
          ...
          builder: (BuildContext context) => new AlertDialog(
            title: new Text("Download the app for better experience"),
            content: InkWell(
                onTap: () {
                  _launchInBrowserE(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: CarouselSlider(
                                                ...
                                                items: [
                                                  SelectableText(
                                                      '  Book experienced purohit near you.',
                                                      style: TextStyle(
                        ...
                        Expanded(
                          ...
                          child: Container(
                              ...
                              height: ResponsiveWidget.isMediumScreen(context)
                                  ...
                                  : height * 0.55,
                              child: Image.network(
                                  "https://firebasestorage.googleapis.com/v0/b/flutter-bf503.appspot.com/o/website%2FGroup%202.png?alt=media&token=c9dafa09-2684-4d1b-ad1b-1452d800b13d")),
                        )
                      ],
                    ),
                    Container(
                      width: width,
                      height:
                          ResponsiveWidget.isMediumScreen(context) ? 300 : 450,
                            ...
                            children: [
                              Expanded(
                                  ...
                                  child: Column(
                                    children: [
                                      Image.network(
                                        "https://firebasestorage.googleapis.com/v0/b/flutter-bf503.appspot.com/o/website%2FGroup%207.png?alt=media&token=56d60d23-7a32-47c2-9dc9-f14ff951dd4a",
                                        height: ResponsiveWidget.isMediumScreen(
                                                context)
                                            ? 120
                                            : 196,
                                      ...
                                      Text1(
                                        data: "BOOK FOR YOUR LOVED ONE",
                                        max: ResponsiveWidget.isMediumScreen(
                                                context)
                                            ? 11
                                            : 14,
                                        min: ResponsiveWidget.isMediumScreen(
                                                context)
                                            ? 10
                                            : 12,
                                        clr: Colors.white,
                                      ...
                                      Text1(
                                        data:
                                            "BOOK FOR YOURSELF AND YOUR LOVES ONES",
                                        max: ResponsiveWidget.isMediumScreen(
                                                context)
                                            ? 11
                                            : 14,
                              ...
                              Expanded(
                                  ...
                                  child: Column(
                                    children: [
                                      Image.network(
                                        "https://firebasestorage.googleapis.com/v0/b/flutter-bf503.appspot.com/o/website%2FFrame.png?alt=media&token=e8954c1c-86f5-4967-8191-756c09938d1a",
                                        height: ResponsiveWidget.isMediumScreen(
                                                context)
                                            ? 120
                                            : 196,
                                      ...
                                      Text1(
                                        data:
                                            "LIVE TRACK YOUR PUROHIT WITH OUR LATEST ETA SYSTEM",
                                        max: ResponsiveWidget.isMediumScreen(
                                                context)
                                            ? 11
                                            : 14,
                              ...
                              Expanded(
                                  ...
                                  child: Column(
                                    children: [
                                      Image.network(
                                        "https://firebasestorage.googleapis.com/v0/b/flutter-bf503.appspot.com/o/website%2FGroup%205.png?alt=media&token=590b994b-1c62-41a0-b528-f532616dd2ea",
                                        height: ResponsiveWidget.isMediumScreen(
                                                context)
                                            ? 120
                                            : 196,
                                      ...
                                      Text1(
                                        data:
                                            "GET YOUR SAMGRI AND PRODUCTS WITH THE LIGHTNING FAST DELIVERY",
                                        max: ResponsiveWidget.isMediumScreen(
                                                context)
                                            ? 11
                                            : 14,
                        ...
                        children: [
                          Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text("Hinduism Activities in your pocket",
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Image.network(
                                      "https://firebasestorage.googleapis.com/v0/b/flutter-bf503.appspot.com/o/website%2F1626627424375%201.png?alt=media&token=8f672abb-9468-4fa6-8640-39633ea11f67",
                                      height: height * 0.6,
                                      width: width * 0.2,
                                    ),
                                  ),
                                  ...
                                  Padding(
                                    padding:
                                        EdgeInsets.only(bottom: height * 0.23),
                                    child: Image.network(
                                      "https://firebasestorage.googleapis.com/v0/b/flutter-bf503.appspot.com/o/website%2F1626627304499%201.png?alt=media&token=c82ef1b8-5101-4323-b43f-6573d0d86214",
                                      height: height * 0.8,
                                      width: width * 0.2,
                                    ),
                                  )
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(
                  left: width * 0.1, right: width * 0.1, bottom: width * 0.07),
              child: Column(
                ...
                children: [
                  CarouselSlider(
                    ...
                    items: [
                      SelectableText(
                        "Help us in reviving our culture",
                        textAlign: TextAlign.center,
                        style: GoogleFonts.firaSans(
                            fontSize: 24,
                      ...
                      SelectableText(
                        "India's first intercity pandit booking platform",
                        textAlign: TextAlign.center,
                        style: GoogleFonts.firaSans(
                            fontSize: 24,
                            fontWeight: FontWeight.w700,
                      ...
                      SelectableText(
                        "Easy online and cod payments available",
                        textAlign: TextAlign.center,
                        style: GoogleFonts.firaSans(
                            fontSize: 24,
                            fontWeight: FontWeight.w700,
                  ...
                  Text2(
                    data: "Continue your spritual journey",
                    max: 12,
                    clr: Colors.black54,
                  ),
                  SizedBox(
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Container(height: height * 0.8, child: Auth())
        ],
      ),
    );
  }
